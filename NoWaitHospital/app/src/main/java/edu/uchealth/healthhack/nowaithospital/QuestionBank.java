...
public class QuestionBank {
    ...
    public QuestionBank() {
        ...
        // Main Question
        List<String> keyInjury = Arrays.asList("cut", "shot", "blood", "bleeding", "wound", "laceration", "lacerated", "dislocation", "dislocated", "amputated", "injury", "bruised", "injured", "broken", "wounded");
